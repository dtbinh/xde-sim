...
//---------------------------------------------
// Capsule object primitive
//---------------------------------------------
xde::xgl::TriMeshRef GeometricObjects::createImplicitCapsule( const	std::string&			name,
																															const	Eigen::Vector3d&	p,
																															const	Eigen::Vector3d&	q,
																															double									radius)
{
	xde::xgl::TriMeshRef mesh = xde::xgl::TriMeshRef::createObject(name + ".mesh");
	xde::xgl::SimplicialComplexRef simp = mesh.getSimplicialComplex();
